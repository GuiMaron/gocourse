...
type Screen struct {
	...
	SizeInches uint32             `protobuf:"varint,1,opt,name=size_inches,json=sizeInches,proto3" json:"size_inches,omitempty"`
...
func (x *Screen) GetSizeInches() uint32 {
	if x != nil {
		return x.SizeInches
	}
	return 0
...
var file_screen_message_proto_rawDesc = []byte{
	...
	0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0a, 0x73, 0x69, 0x7a, 0x65, 0x49, 0x6e, 0x63,
